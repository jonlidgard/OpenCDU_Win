...
* Effect:
*       Notifies the main thread that a simconnect error has occurred
****************************************************************************/

#define UWM_SIMCONNECT_ERROR (WM_APP + 211)

/****************************************************************************
*                                  UWM_SIMCONNECT_INFO
* Inputs:
*       WPARAM: (WPARAM)(DWORD) Info code
*       LPARAM: (LPARAM)(DWORD) thread ID of thread that is logging info
* Result: LRESULT
*       Logically void, 0, always
* Effect:
...
#define UWM_SIMCONNECT_INFO (WM_APP + 212)
...
#define UWM_SIMCONNECT_DATA    (WM_APP+213)    